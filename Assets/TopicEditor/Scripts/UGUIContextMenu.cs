...
public class UGUIContextMenu : MonoBehaviour, IPointerExitHandler
{
	...
	public void SpawnConstantNode()
	{
		SpawnNode(typeof(ConstantNode));
	}

	public void SpawnVectorNode()
	{
		SpawnNode(typeof(VectorNode));
	}
	...
	{
		RuntimeTopicGraph runtimeMathGraph = GetComponentInParent<RuntimeTopicGraph>();
